...
-(void)loadDataForPage{
    ...
    [[[ZCUIConfigManager getInstance] getZCAPIServer] getOrderMsgTypeWithUid:[self getCurConfig].uid start:^{
...
- (void)customLayoutSubviewsWith:(ZCKitInfo *)zcKitInfo{
    // 屏蔽橡皮筋功能
    self.automaticallyAdjustsScrollViewInsets = NO;
    _listTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, viewWidth, viewHeigth) style:UITableViewStyleGrouped];
...
-(void)viewDidLayoutSubviews{
    ...
    [self setTableSeparatorInset];
    [self.listTable setFrame:CGRectMake(0, 0, viewWidth, viewHeigth)];
