//
//  WMNotificationMessageViewController.m
//  WMDoctor
//
...
@interface WMNotificationMessageViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation WMNotificationMessageViewController
...
- (void)loadDataWithPage:(NSInteger)pageIndex{
    ...
    messageLisParamModel.type=@"1002";
    ...
    [messageTypeAPIManager loadDataWithParams:messageLisParamModel.toDictionary withSuccess:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        if (_dataSource.count == 0) {
            ...
            _tableView.mj_footer.hidden = YES;
             [_tableView showBackgroundView:@"暂无记录" type:BackgroundTypeNOTongZhi];
        }
