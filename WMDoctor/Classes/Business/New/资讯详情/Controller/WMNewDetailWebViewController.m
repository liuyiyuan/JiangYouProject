//
//  WMNewDetailWebViewController.m
//  WMDoctor
//
...
@interface WMNewDetailWebViewController ()<UMSocialShareMenuViewDelegate>

@end

@implementation WMNewDetailWebViewController
...
- (void)viewDidLoad {
    ...
    self.shareUrl = [NSString stringWithFormat:@"%@&isShare=true",self.shareUrl];
