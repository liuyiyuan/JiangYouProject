...
- (void)commonInit {
    ...
    // 触发懒加载
    self.segmentView.backgroundColor = [UIColor colorWithRed:80 / 255.0 green:184 / 255.0 blue:251 / 255.0 alpha:1];
    self.contentView.backgroundColor = [UIColor colorWithRed:80 / 255.0 green:184 / 255.0 blue:251 / 255.0 alpha:1];
}
